...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "boot_sound_desc": "Play a jingle when Oh My Island starts",
        ...
        // Window
        "settings_title": "Oh My Island Settings",
        ...
        "update_available_body": "Oh My Island %@ is available (current: %@). Would you like to download it?",
        "download_update": "Download",
        "later": "Later",
        "no_update_title": "Up to Date",
        "no_update_body": "Oh My Island %@ is the latest version.",
        "ok": "OK",
    ...
    private static let zh: [String: String] = [
        ...
        "system_section": "系统",
        "boot_sound": "启动音效",
        "boot_sound_desc": "Oh My Island 启动时播放提示音",
        "interaction": "交互",
        ...
        // Window
        "settings_title": "Oh My Island 设置",
        ...
        "update_available_body": "Oh My Island %@ 已发布（当前版本：%@），是否前往下载？",
        "download_update": "前往下载",
        "later": "稍后",
        "no_update_title": "已是最新版本",
        "no_update_body": "Oh My Island %@ 已是最新版本。",
        "ok": "好",
