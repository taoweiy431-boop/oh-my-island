...
lipo -create "$ARM_DIR/ohmyisland-bridge" "$X86_DIR/ohmyisland-bridge" \
     -output "$APP_BUNDLE/Contents/Helpers/ohmyisland-bridge"
...
codesign --force --sign - "$APP_BUNDLE/Contents/Helpers/ohmyisland-bridge"
